...
![Figure: Data flow overview](./images/dataflow.pdf)
...
![Figure: Interface Screenshot](./images/screenshot.png)

The development of **SRAmetaDBB** is actively progressing in its GitHub repository (https://github.com/nishad/srameta-dbb), where ongoing improvements are made based on the results of the test cases. Despite being incomplete, the tool is already functional for creating some of the intended database stages. While still a work in progress, several key features have already been implemented, and sample output files have been published for testing and reference. These files include:
...
[^3]: https://github.com/asg017/sqlite-vec
